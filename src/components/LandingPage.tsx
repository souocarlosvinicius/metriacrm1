        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            ...
            <div className="bg-slate-900 text-white border-2 border-amber-500 rounded-2xl p-5 flex flex-col justify-between relative overflow-hidden shadow-lg shadow-amber-500/10">
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  <span className="text-[9px] bg-amber-400/20 text-amber-400 px-2 py-0.5 rounded-full font-bold uppercase tracking-wider font-semibold font-sans">Exclusivo</span>
                  <h3 className="font-display text-lg font-bold text-white">Plano PRO MAX</h3>
                  <p className="text-[11px] text-slate-300">Para imobiliárias maiores, redes e operações comerciais com gestão avançada.</p>
                </div>
                <div className="pt-2">
                  <div className="flex items-baseline gap-1">
              ...
              <button 
                onClick={() => onGetStarted(true)}
                className="w-full mt-6 py-2.5 bg-amber-500 hover:bg-amber-600 text-slate-950 text-xs font-bold rounded-xl transition-all shadow-md cursor-pointer text-center"
              >
                Falar com Vendas
              </button>
            </div>
